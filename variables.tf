...
variable "public_frontend_private_link_configuration_name" {
  type        = string
  default     = null
  description = "(Optional) The name of a private link configuration for the public Frontend IP Configuration"
}
